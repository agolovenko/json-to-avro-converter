...
class JsonParser(stringParsers: Map[String, String => Any] = Map.empty) {
  ...
  private def readAny(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): Any = schema.getType match {
  ...
  private def readRecord(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): GenericData.Record =
    data match {
  ...
  private def readEnum(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): GenericData.EnumSymbol = {
  ...
  private def readArray(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): GenericData.Array[Any] =
    data match {
  ...
  private def readMap(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): JMap[String, Any] =
    data match {
      case JsDefined(obj: JsObject) =>
  ...
  private def readUnion(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): Any = {
  ...
  private def readBytes(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): Any =
    read[String](data, schema, defaultValue)

  private def readFixed(data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): GenericData.Fixed = {
  ...
  private def read[T: Reads](data: JsLookupResult, schema: Schema, defaultValue: Option[Any])(implicit path: mutable.ArrayStack[String]): Any = data match {
  ...
  private def fallbackToDefault(defaultValue: Option[Any], schema: Schema)(implicit path: mutable.ArrayStack[String]): Any =
    defaultValue.fold(throw new MissingValueException(schema)) { extractDefaultValue(_, schema) }

  private def extractDefaultValue(defaultValue: Any, schema: Schema)(implicit path: mutable.ArrayStack[String]): Any = (schema.getType, defaultValue) match {
